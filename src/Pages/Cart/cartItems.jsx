            ...
            <div className="info w-[85%] relative">
                ...
                <div className="flex items-center gap-4 mt-2">
                    <div className='relative'>
                        ...
                        <span className='flex items-center justify-center bg-[#f1f1f1] text-[11px] font-[600] py-1 px-2 rounded-md cursor-pointer' onClick={handleClickSize}>Size: S {selectedSize}<GoTriangleDown /></span>
                        <Menu
                            id="size-menu"
