...
const CartPanel = () => {
    return (
        <div>
         {/*.scroll ma  max-h-[300px] che  */}
            <div className="scroll w-full max-h-[740px] overflow-y-scroll overflow-x-hidden py-3 px-4">
                <div className="cartItem w-full flex items-center gap-4 border-b border-[rgba(0,0,0,0.1)] pb-4">
                    <div className="img w-[25%] overflow-hidden h-[80px] rounded-md">
                        <Link to="/product/45875" className='block group'>
                            ...
                            <img src="\img\pic-1.2.jpg" alt="" className='w-full group-hover:scale-105' />
                        </Link>
                    </div>

                    <div className="info w-[75%] pr-5 relative">
                        <h4 className='text-[14px] font-[500]'>
                            <Link to="/product/5485" className='link '>
                                Men Opaque Casual
                            </Link>
                        </h4>
            ...
            <div className="bottomSec absolute bottom-[10px] left-[10px] w-full">
                ...
                <div className="bottomInfo py-3 px-4 w-full border-t border-[rgba(0,0,0,0.1)] flex items-center justify-between flex-col">
                    ...
                    <div className="flex items-center justify-between w-full gap-5">
                        ...
                        <Link to="/check out" className='w-[50%] d-block'><Button className='btn-org btn-lg w-full'>Check out</Button></Link>
                        {/* <Button className='btn-org btn-lg w-[50%]'></Button> */}
                    </div>
                </div>
            </div>
